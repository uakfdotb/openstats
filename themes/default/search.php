...
?>
  ...
  <h2><?=$lang["search_results"]?> <?=$s?></h2>
   ...
   <div style="margin-top: 20px;">
	<table>
	<tr>
	 <th width="220" class="alignleft padLeft"><?=$lang["player_name"]?></th>
	 <th width="90" class="alignleft"><?=$lang["score"]?></th>
	 <th width="90" class="alignleft"><?=$lang["games"]?></th>
	 <th width="180" class="alignleft"><?=$lang["kda"]?></th>
	</tr>
	<?php
	...
	<tr class="row">
	  ...
	  <td width="90" class="alignleft"><?=$Search["score"]?></td>
	  <td width="90" class="alignleft"><?=$Search["games"]?></td>
	  <td width="180" class="alignleft">
